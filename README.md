...
<img width="1928" height="1083" alt="Dashboard2 0" src="https://github.com/user-attachments/assets/ddc068ab-122f-442f-99b9-e1fc6c86f04d" />

### 
- **Country and Job Type Slicers:**
This section allows anyone to filter through a specefic job type or country to further narrow down data on jobs.
...
This map allows the user to easily see where a specefic job type is and identify the assosiated number of jobs for a specefic region.
...
These cards allow easy snapshot data into what the job count is and salary associated for a speceifc country, skill, or company filter.
...
This section provides information on what skills are learned along with the job count. There are two slicers at the bottom specefic for this bar chart which allows the user to filter between the job count and job percent for a certain skill.
...
This section is similair to the previous one but takes into account the salary associated with any skills. The slicers at the bottom of this chart helps differentiate the hourly and yearly salary for a specefic skill type.
...
This chart allows the user to quickly see which companies offer the most earning potential. It is important to note that some companies only have either 3 or fewer posting which does not accurately represent the true mediian salary for a company.
...
- I can see how valuable this is when paired with other programs such as SQL or Python to extract the raw data and then visualize and adapt the data in PowerBI. It not only leads to important desicions from stakeholders, but allows anyone to interpret large amounts of data that looks intimidating at first that you may see with millions of rows in an excel file. I think you can take it even further with AI and their visualization tools as well to fully understand what you're looking at.
